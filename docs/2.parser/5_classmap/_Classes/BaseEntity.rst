...
**Return value:** `BumbleDocGen\\Parser\\AttributeParser </docs/2\.parser/5_classmap/_Classes/AttributeParser\.rst>`_
...
.. raw:: html
    ...
    <tbody>
            <tr>
            <td>$context</td>
            <td><a href='/docs/2.parser/5_classmap/_Classes/Context.rst'>BumbleDocGen\Render\Context\Context</a> | null</td>
            <td>-</td>
        </tr>
        </tbody>
    </table>
