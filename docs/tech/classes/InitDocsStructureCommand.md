<!-- {% raw %} -->
<embed> <a href="/docs/README.md">BumbleDocGen</a> <b>/</b> <a href="/docs/tech/readme.md">Technical description of the project</a> <b>/</b> <a href="/docs/tech/map.md">Class map</a> <b>/</b> InitDocsStructureCommand<hr> </embed>

<h1>
    <a href="https://github.com/bumble-tech/bumble-doc-gen/blob/master/src/AI/Console/InitDocsStructureCommand.php#L18">InitDocsStructureCommand</a> class:
</h1>
...
final class InitDocsStructureCommand extends \BumbleDocGen\Console\Command\BaseCommand
```
...
<ul>
            ...
            <li><a name="qname"
               href="#qname">#</a>
            <code>NAME</code>                   <b>|</b> <a href="/src/AI/Console/InitDocsStructureCommand.php#L22">source
                    code</a> </li>
            <li><a name="qsuccess"
               href="#qsuccess">#</a>
