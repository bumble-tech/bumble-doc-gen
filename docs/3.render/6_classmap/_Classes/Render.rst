...
#. `\\ConfigurationInterface::getTemplatesDir\(\) </docs/3.render/6_classmap/_Classes/ConfigurationInterface.rst#mgettemplatesdir>`_ 
#. `\\ConfigurationInterface::getOutputDir\(\) </docs/3.render/6_classmap/_Classes/ConfigurationInterface.rst#mgetoutputdir>`_ 
