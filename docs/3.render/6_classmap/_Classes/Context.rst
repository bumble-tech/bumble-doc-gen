...
.. raw:: html
    ...
    <tbody>
            <tr>
            <td>$configuration</td>
            <td><a href='/docs/3.render/6_classmap/_Classes/ConfigurationInterface.rst'>BumbleDocGen\ConfigurationInterface</a></td>
            <td>-</td>
        </tr>
            <tr>
            <td>$classEntityCollection</td>
            <td><a href='/docs/3.render/6_classmap/_Classes/ClassEntityCollection.rst'>BumbleDocGen\Parser\Entity\ClassEntityCollection</a></td>
            <td>-</td>
        </tr>
            <tr>
            <td>$breadcrumbsHelper</td>
            <td><a href='/docs/3.render/6_classmap/_Classes/BreadcrumbsHelper.rst'>BumbleDocGen\Render\Breadcrumbs\BreadcrumbsHelper</a></td>
            <td>-</td>
        </tr>
            <tr>
            <td>$pluginEventDispatcher</td>
            <td><a href='/docs/3.render/6_classmap/_Classes/PluginEventDispatcher.rst'>BumbleDocGen\Plugin\PluginEventDispatcher</a></td>
            <td>-</td>
        </tr>
        </tbody>
    </table>
...
**Return value:** `BumbleDocGen\\ConfigurationInterface </docs/3\.render/6_classmap/_Classes/ConfigurationInterface\.rst>`_
...
**Return value:** `BumbleDocGen\\Parser\\Entity\\ClassEntityCollection </docs/3\.render/6_classmap/_Classes/ClassEntityCollection\.rst>`_
...
**Return value:** `BumbleDocGen\\Render\\Breadcrumbs\\BreadcrumbsHelper </docs/3\.render/6_classmap/_Classes/BreadcrumbsHelper\.rst>`_
...
**Return value:** `BumbleDocGen\\Plugin\\PluginEventDispatcher </docs/3\.render/6_classmap/_Classes/PluginEventDispatcher\.rst>`_
