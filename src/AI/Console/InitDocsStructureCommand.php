...
final class InitDocsStructureCommand extends BaseCommand
{
    use SharedCommandLogicTrait;

    public const NAME = 'ai:init-docs-structure';
    ...
    protected function configure(): void
    {
        $this->setName(self::NAME)
            ->setDescription('Leverage AI to establish a documentation structure with empty files.');
    ...
    protected function execute(
        ...
        $this->createDocGenInstance($input, $output)->initDocsStructure(
            $provider,
            $apiKey,
            $model,
            $nonInteractive,
